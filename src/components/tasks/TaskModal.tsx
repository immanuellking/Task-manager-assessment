...
export default function TaskModal({
  ...
  return (
    <div
      className={`${
        isOpen
          ? "fixed top-0 left-0 bottom-0 right-0 flex justify-center items-center"
          : "hidden"
      }`}
    >
      <form
        onSubmit={handleSubmit}
        className="p-4 py-8 sm:p-8 space-y-4 bg-[#4338ca] dark:bg-black rounded-lg shadow-lg m-auto w-[90%] lg:w-[40rem] z-50"
      >
